...
check in  ~/.m2/repository/com/netflix/eureka/eureka-core/
if you already have a 2.0.2 eureka, you may want to delete it to show the cache being updated
`rm -fr  ~/.m2/repository/com/netflix/eureka/`
